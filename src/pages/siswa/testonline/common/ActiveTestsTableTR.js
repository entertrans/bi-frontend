      ...
      Swal.fire({
        ...
        html: `
          <div class="text-center">
            ...
            <p class="text-lg font-semibold mb-2">Anda sedang mengerjakan test lain</p>
            <p class="text-gray-600">Selesaikan test yang sedang berjalan terlebih dahulu sebelum memulai test baru.</p>
          </div>
        `,
        icon: "warning",
    ...
    return (
      ...
      >
        ...
        <p className="text-gray-600 dark:text-gray-400 text-sm">
          Semua test review telah selesai atau belum ada penugasan
        </p>
      </div>
    );
  }
    ...
    >
      ...
      <div className="mb-4 p-3 bg-blue-100 dark:bg-blue-900/30 rounded-lg">
        <span className="text-sm font-medium text-blue-800 dark:text-blue-200">
          📊 Menampilkan {tests.length} test review aktif
          {currentActiveSession && " • Ada test yang sedang dikerjakan"}
        </span>
      </div>
                  ...
                  <div className="col-span-3">
                    ...
                    {isOtherActive && !session && (
                      <div className="mt-2 text-xs text-orange-600 dark:text-orange-400 text-center flex items-center justify-center">
                        ...
                        Selesaikan test yang sedang berjalan
                      </div>
                    )}
                  </div>
                </div>
